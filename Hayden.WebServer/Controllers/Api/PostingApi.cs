...
public partial class ApiController
{
		...
		IFormFile file, DBBoard boardInfo, string extension)
	{
		...
		var destinationFilename = HaydenThreadConsumer.CalculateFilename(DataConfig.Value.FileLocation,
			Common.MediaType.FullImage, 1, extension);

		var thumbnailFilename = HaydenThreadConsumer.CalculateFilename(DataConfig.Value.FileLocation,
