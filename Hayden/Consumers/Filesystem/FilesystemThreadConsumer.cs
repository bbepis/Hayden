...
public class FilesystemThreadConsumer : IThreadConsumer
{
	...
	{
		ContractResolver = new IgnoreOriginalObjectResolver(),
	...
	private class IgnoreOriginalObjectResolver : DefaultContractResolver
	{
			...
			MemberSerialization memberSerialization)
		{
			...
			var originalObjectProperty = properties.FirstOrDefault(x => x.PropertyName == "OriginalObject");

			if (originalObjectProperty != null)
				properties.Remove(originalObjectProperty);
